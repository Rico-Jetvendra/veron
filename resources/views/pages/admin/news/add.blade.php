                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="news_title" placeholder="Enter News Title" id="news_title">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="news_tag" placeholder="Enter News Code" id="news_tag" data-role="tagsinput">
                            </div>
                        </div>
                    </div>
                    <div class="row">
